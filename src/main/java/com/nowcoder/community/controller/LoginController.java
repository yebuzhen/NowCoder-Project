...
public class LoginController implements CommunityConstant {
  ...
  public String register(Model model, User user) {
    ...
    if (map == null || map.isEmpty()) {
      ...
      model.addAttribute(
          "msg", "Registered successful! We have sent you an activation email, please activate.");
  ...
  public void getKaptcha(HttpServletResponse response /*, HttpSession session*/) {
    ...
    // The owner of the kaptcha
    String kaptchaOwnerCertificate = CommunityUtil.generateUUID();
    Cookie cookie = new Cookie("kaptchaOwnerCertificate", kaptchaOwnerCertificate);
    cookie.setMaxAge(60);
    cookie.setPath(contextPath);
    response.addCookie(cookie);
    // Put the kaptcha into Redis
    String redisKey = RedisKeyUtil.getKaptchaKey(kaptchaOwnerCertificate);
  ...
  public String login(
      ...
      @CookieValue("kaptchaOwnerCertificate") String kaptchaOwnerCertificate) {

    // Validate Kaptcha
    //        String kaptcha = (String) session.getAttribute("kaptcha");

    String kaptcha = null;
    if (StringUtils.isNotBlank(kaptchaOwnerCertificate)) {
